package test.shop.app.controllers.api.utils;
...
import test.shop.app.helper.uimodels.site.slider.UploadForm;
...
public class UploadFileController {
    ...
    public ServiceResponse<String> getListFiles() {
        ...
        return new ServiceResponse<String>(ResponseStatus.SUCCESS, list);
    }
