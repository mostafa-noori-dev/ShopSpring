app.controller("categoryListCtrl", function ($scope, apiHandler,$rootScope) {
    ...
    $scope.dataList = [];
    $scope.getDataList = () => {
        let url = "productCategory/getAll?pageSize=" + $scope.query.pageSize + "&pageNumber=" + $scope.query.pageNumber;
    ...
    $scope.showProducts=(productCategory)=>{
        $rootScope.productCategory=productCategory;
